...
# Celem analizy jest okreslenie liczby zatrudnonych pielêgniarek i po³o¿nych w 2027 roku.
# Wykorzystane dane o strukturze wiekowej pielêgniarek pochodz¹ z raportu nipip: http://arch.nipip.pl/attachments/article/3368/Raport_2015_NIPiP.pdf

# Zaobserwowano, ¿e w roku 2017 a¿ 35627 zatrudnionych pielêgniarek i po³o¿nych znajduje siê w wieku emerytalnym.

# Na potrzeby analiy zalo¿ono, ¿e podobna tendecja utrzyma siê w przysz³oœci.

# W celu okreœlenia tempa przejœæ na emerytujê wykonano eksploracyjna anali¿e danych obejmuj¹c¹ liczebnoœæ nastepuj¹cych grup wiekowych: "56-60", "61-65", "66-70" oraz "powy¿ej 70".
# Na potrzeby analizy za³ozono brak pielêgniarek i po³o¿nych w ostatniej z wymienonych grup oraz zbli¿on¹ liczebnosæ ka¿dej kohorty przed osi¹gnieciem wieku emerytalnego.
